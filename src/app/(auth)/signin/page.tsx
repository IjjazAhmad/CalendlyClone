    ...
    <div className="flex justify-center items-center flex-col w-full">
      ...
      <form className='px-[33px] py-[33px] mb-[33px] border border-borderClr-1 shadow-2 rounded-md w-[95%] sm:w-[440px] ' onSubmit={handleSubmit}>
        <div className='mb-[12px]'>
          <label htmlFor="name" className='text-black font-bold text-sm'>Enter your name</label>
          <input type="text" name='name' value={state.name} className='px-[15px] py-[14px] mt-[8px] w-full border border-borderClr-2 rounded-lg text-black font-normal text-[16px]' style={{ outline: "none" }} onChange={handleChange} placeholder='name' />
        </div>
        <div className='mb-[12px]'>
        ...
        <Link href={"/signup"}><p className='mt-[27px]  font-normal text-[12px] text-center'>If you don't have an account<span className='text-primary'>Sign Up</span></p></Link>
      </form>
    </div>
  );
}
